/*
 * Samsung Galaxy Z Fold 5 (SM-F946B), F946BXXS7GZG1.
 *
 * The constants and P0 fingerprint are derived from the supplied exact boot
 * image. This target uses the repository's existing core61 compatibility route;
 * exploit and KernelSU execution remain unverified on hardware.
 */
 ...
 * ------------------------------------------------------------------------- */
#define BUILD_VARIANT_LABEL "q5q-F946BXXS7GZG1-app"
...
#define BUILD_FINGERPRINT \
  "samsung/q5qxxx/q5q:13/TP1A.220624.014/F946BXXS7GZG1:user/release-keys"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/q5q/xx/5.15.189-android13-8-33404244-abF946BXXS7GZG1/p0_fingerprint.h"
...
/* --- slide leak symbols ---------------------------------------------------- */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01d5dcdcULL
